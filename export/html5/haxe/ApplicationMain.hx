...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("LudumDare46", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("LudumDare46", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "LudumDare46";
		app.meta["name"] = "LudumDare46";
